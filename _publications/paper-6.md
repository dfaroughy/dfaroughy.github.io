...
category: ml_papers
date: 2021-12-07
excerpt: 'We introduce the **LHC Olympics 2020**, a community challenge where the participants develop their machine learning methods using an R&D dataset and then tested them on black box datasets with an unknown anomaly. We describe each of the proposed methods based on unsupervised learning (autoencoders, generative adversarial networks, normalizing flows), weakly supervised learning, and semi-supervised learning.'
